...
export const DATA = {
  ...
  description:
    "A man who turn a cup of 🍵 coffee into beautiful code!",
  summary: "Hello! I'm from Padangsidimpuan, Indonesia. I enjoy programming and exploring technology. Currently working on my own projects. Open to work, freelance, or **collaborate**.\n\n Constantly interested in problem solving, reviewing colleagues code and refactoring and optimising existing code. Always ready to learn new **technology**, update existing knowledge or work harder. Proud member of Open-Source Community.",
