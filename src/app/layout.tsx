...
export const metadata: Metadata = {
  ...
  title: {
    default: "Arie Dalimunthe | Full Stack Developer",
    template: `%s | Arie Dalimunthe`,
  },
  description: "Arie Dalimunthe is a Full Stack Developer from Indonesia, with expertise in React, Next.js, TypeScript and Node.js. I create modern web applications and have a passion for clean, efficient code. View my portfolio to see my latest projects and technical blog posts.",
  keywords: ["Arie Dalimunthe", "Full Stack Developer", "PHP Developer", "Web Developer Indonesia", "Software Engineer"],
  authors: [{ name: "Arie Dalimunthe" }],
  creator: "Arie Dalimunthe",
  publisher: "Arie Dalimunthe",
  alternates: {
    canonical: DATA.url,
  },
  openGraph: {
    title: "Arie Dalimunthe | Full Stack Developer",
    description: "Full Stack Developer specializing in PHP, Check out my portfolio, projects and blog posts.",
    url: DATA.url,
    siteName: "Arie Dalimunthe - Portfolio",
    locale: "en_US",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Arie Dalimunthe - Full Stack Developer"
      }
    ]
  },
  twitter: {
